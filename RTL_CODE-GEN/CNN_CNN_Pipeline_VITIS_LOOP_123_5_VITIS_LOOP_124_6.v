...
module CNN_CNN_Pipeline_VITIS_LOOP_123_5_VITIS_LOOP_124_6 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [63:0] line_buffer_1_2_q0;
output  [63:0] max_val_3_out;
...
reg   [63:0] max_val_3_load_1_reg_297;
reg   [63:0] line_buffer_1_2_load_reg_304;
wire   [63:0] zext_ln124_fu_144_p1;
wire    ap_block_pp0_stage0;
reg   [63:0] max_val_3_fu_54;
wire   [63:0] max_val_6_fu_251_p3;
reg   [63:0] ap_sig_allocacmp_max_val_3_load_1;
wire    ap_loop_init;
reg   [1:0] b_fu_58;
wire   [1:0] add_ln124_fu_149_p2;
reg   [1:0] ap_sig_allocacmp_b_load;
reg   [2:0] indvar_flatten995_fu_62;
wire   [2:0] add_ln123_fu_121_p2;
reg   [2:0] ap_sig_allocacmp_indvar_flatten995_load;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln123_fu_115_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten995_fu_62 <= add_ln123_fu_121_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten995_fu_62 <= 3'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            max_val_3_fu_54 <= max_val;
        end else if ((ap_enable_reg_pp0_iter2 == 1'b1)) begin
            max_val_3_fu_54 <= max_val_6_fu_251_p3;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        line_buffer_1_2_load_reg_304 <= line_buffer_1_2_q0;
        max_val_3_load_1_reg_297 <= ap_sig_allocacmp_max_val_3_load_1;
    end
end
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_indvar_flatten995_load = 3'd0;
    end else begin
        ap_sig_allocacmp_indvar_flatten995_load = indvar_flatten995_fu_62;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        ap_sig_allocacmp_max_val_3_load_1 = max_val_6_fu_251_p3;
    end else begin
        ap_sig_allocacmp_max_val_3_load_1 = max_val_3_fu_54;
    end
end
...
assign add_ln123_fu_121_p2 = (ap_sig_allocacmp_indvar_flatten995_load + 3'd1);
...
assign bitcast_ln126_1_fu_186_p1 = max_val_3_load_1_reg_297;

assign bitcast_ln126_fu_169_p1 = line_buffer_1_2_load_reg_304;

assign grp_fu_11355_p_ce = 1'b1;

assign grp_fu_11355_p_din0 = line_buffer_1_2_q0;

assign grp_fu_11355_p_din1 = ap_sig_allocacmp_max_val_3_load_1;

assign grp_fu_11355_p_opcode = 5'd2;

assign icmp_ln123_fu_115_p2 = ((ap_sig_allocacmp_indvar_flatten995_load == 3'd4) ? 1'b1 : 1'b0);
...
assign icmp_ln126_2_fu_221_p2 = ((tmp_25_fu_189_p4 != 11'd2047) ? 1'b1 : 1'b0);

assign icmp_ln126_3_fu_227_p2 = ((trunc_ln126_3_fu_199_p1 == 52'd0) ? 1'b1 : 1'b0);

assign icmp_ln126_fu_203_p2 = ((tmp_24_fu_172_p4 != 11'd2047) ? 1'b1 : 1'b0);

assign line_buffer_1_2_address0 = zext_ln124_fu_144_p1;

assign max_val_3_out = max_val_3_fu_54;

assign max_val_6_fu_251_p3 = ((and_ln126_1_fu_245_p2[0:0] == 1'b1) ? line_buffer_1_2_load_reg_304 : max_val_3_load_1_reg_297);
...
assign tmp_24_fu_172_p4 = {{bitcast_ln126_fu_169_p1[62:52]}};

assign tmp_25_fu_189_p4 = {{bitcast_ln126_1_fu_186_p1[62:52]}};

assign trunc_ln126_3_fu_199_p1 = bitcast_ln126_1_fu_186_p1[51:0];

assign trunc_ln126_fu_182_p1 = bitcast_ln126_fu_169_p1[51:0];

assign zext_ln124_fu_144_p1 = select_ln122_fu_136_p3;

endmodule //CNN_CNN_Pipeline_VITIS_LOOP_123_5_VITIS_LOOP_124_6
