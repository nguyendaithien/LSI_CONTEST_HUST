...
module CNN_CNN_Pipeline_VITIS_LOOP_63_7_VITIS_LOOP_64_828 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        window_buffer_5_we0,
        window_buffer_5_d0,
        window_buffer_5_address1,
        window_buffer_5_ce1,
        window_buffer_5_q1,
        line_buffer_15_load_2,
        line_buffer_16_load_3,
        line_buffer_17_load_3
);
...
output  [3:0] window_buffer_5_address1;
output   window_buffer_5_ce1;
input  [63:0] window_buffer_5_q1;
input  [63:0] line_buffer_15_load_2;
input  [63:0] line_buffer_16_load_3;
input  [63:0] line_buffer_17_load_3;

reg ap_idle;
reg window_buffer_5_ce0;
reg window_buffer_5_we0;
reg[3:0] window_buffer_5_address1;
...
reg   [3:0] window_buffer_5_addr_2_reg_409;
wire   [0:0] addr_cmp_fu_273_p2;
reg   [0:0] addr_cmp_reg_414;
wire   [63:0] tmp_17_fu_279_p5;
wire   [0:0] addr_cmp12_fu_288_p2;
reg   [0:0] addr_cmp12_reg_424;
reg   [63:0] ap_phi_mux_cond73_i89_phi_fu_129_p6;
wire   [63:0] reuse_select13_fu_328_p3;
reg   [63:0] ap_phi_reg_pp0_iter2_cond73_i89_reg_126;
wire   [63:0] reuse_select_fu_320_p3;
wire   [63:0] ap_phi_reg_pp0_iter0_cond73_i89_reg_126;
reg   [63:0] ap_phi_reg_pp0_iter1_cond73_i89_reg_126;
wire   [63:0] p_cast_fu_242_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] p_cast1_fu_253_p1;
wire   [63:0] zext_ln66_4_fu_268_p1;
...
reg   [1:0] row_fu_68;
wire   [1:0] select_ln63_2_fu_210_p3;
reg   [3:0] indvar_flatten1989_fu_72;
wire   [3:0] add_ln63_fu_178_p2;
wire   [0:0] icmp_ln64_fu_196_p2;
wire   [1:0] add_ln63_2_fu_190_p2;
wire   [3:0] tmp_s_fu_222_p3;
wire   [3:0] zext_ln66_fu_218_p1;
wire   [3:0] sub_ln66_fu_230_p2;
wire   [3:0] empty_226_fu_236_p2;
wire   [3:0] empty_227_fu_247_p2;
wire   [3:0] zext_ln66_3_fu_258_p1;
...
CNN_mux_32_64_1_1 #(
    ...
    .dout_WIDTH( 64 ))
mux_32_64_1_1_U230(
    .din0(line_buffer_15_load_2),
    .din1(line_buffer_16_load_3),
    .din2(line_buffer_17_load_3),
    .din3(select_ln63_2_fu_210_p3),
    .dout(tmp_17_fu_279_p5)
);
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_150)) begin
        if (((select_ln63_fu_202_p3 == 2'd2) & (icmp_ln63_fu_172_p2 == 1'd0))) begin
            ap_phi_reg_pp0_iter2_cond73_i89_reg_126 <= tmp_17_fu_279_p5;
        end else if ((1'b1 == 1'b1)) begin
            ap_phi_reg_pp0_iter2_cond73_i89_reg_126 <= ap_phi_reg_pp0_iter1_cond73_i89_reg_126;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            indvar_flatten1989_fu_72 <= 4'd0;
        end else if (((icmp_ln63_fu_172_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
            indvar_flatten1989_fu_72 <= add_ln63_fu_178_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            reuse_addr_reg_fu_56 <= zext_ln66_4_fu_268_p1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            reuse_reg_fu_60 <= ap_phi_mux_cond73_i89_phi_fu_129_p6;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            row_fu_68 <= select_ln63_2_fu_210_p3;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_phi_reg_pp0_iter1_cond73_i89_reg_126 <= ap_phi_reg_pp0_iter0_cond73_i89_reg_126;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln63_fu_172_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        window_buffer_5_addr_2_reg_409 <= zext_ln66_4_fu_268_p1;
    end
end
...
always @ (*) begin
    if ((icmp_ln63_reg_391 == 1'd0)) begin
        if ((select_ln63_reg_395 == 2'd1)) begin
            ap_phi_mux_cond73_i89_phi_fu_129_p6 = reuse_select_fu_320_p3;
        end else if ((~(select_ln63_reg_395 == 2'd1) & ~(select_ln63_reg_395 == 2'd2))) begin
            ap_phi_mux_cond73_i89_phi_fu_129_p6 = reuse_select13_fu_328_p3;
        end else begin
            ap_phi_mux_cond73_i89_phi_fu_129_p6 = ap_phi_reg_pp0_iter2_cond73_i89_reg_126;
        end
    end else begin
        ap_phi_mux_cond73_i89_phi_fu_129_p6 = ap_phi_reg_pp0_iter2_cond73_i89_reg_126;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_157)) begin
        if ((~(select_ln63_fu_202_p3 == 2'd2) & ~(select_ln63_fu_202_p3 == 2'd1))) begin
            window_buffer_5_address1 = p_cast_fu_242_p1;
        end else if ((select_ln63_fu_202_p3 == 2'd1)) begin
            window_buffer_5_address1 = p_cast1_fu_253_p1;
        end else begin
            window_buffer_5_address1 = 'bx;
        end
    end else begin
        window_buffer_5_address1 = 'bx;
    end
...
assign add_ln63_2_fu_190_p2 = (row_fu_68 + 2'd1);

assign add_ln63_fu_178_p2 = (indvar_flatten1989_fu_72 + 4'd1);

assign add_ln64_fu_299_p2 = (select_ln63_fu_202_p3 + 2'd1);

assign add_ln66_fu_262_p2 = (sub_ln66_fu_230_p2 + zext_ln66_3_fu_258_p1);
...
assign ap_phi_reg_pp0_iter0_cond73_i89_reg_126 = 'bx;

assign empty_226_fu_236_p2 = (sub_ln66_fu_230_p2 + 4'd1);

assign empty_227_fu_247_p2 = (sub_ln66_fu_230_p2 + 4'd2);

assign icmp_ln63_fu_172_p2 = ((indvar_flatten1989_fu_72 == 4'd9) ? 1'b1 : 1'b0);

assign icmp_ln64_fu_196_p2 = ((col_fu_64 == 2'd3) ? 1'b1 : 1'b0);

assign p_cast1_fu_253_p1 = empty_227_fu_247_p2;

assign p_cast_fu_242_p1 = empty_226_fu_236_p2;

assign reuse_select13_fu_328_p3 = ((addr_cmp12_reg_424[0:0] == 1'b1) ? reuse_reg_fu_60 : window_buffer_5_q1);

assign reuse_select_fu_320_p3 = ((addr_cmp_reg_414[0:0] == 1'b1) ? reuse_reg_fu_60 : window_buffer_5_q1);

assign select_ln63_2_fu_210_p3 = ((icmp_ln64_fu_196_p2[0:0] == 1'b1) ? add_ln63_2_fu_190_p2 : row_fu_68);
...
assign tmp_s_fu_222_p3 = {{select_ln63_2_fu_210_p3}, {2'd0}};

assign window_buffer_5_address0 = window_buffer_5_addr_2_reg_409;

assign window_buffer_5_d0 = ap_phi_mux_cond73_i89_phi_fu_129_p6;

assign zext_ln66_3_fu_258_p1 = select_ln63_fu_202_p3;

assign zext_ln66_4_fu_268_p1 = add_ln66_fu_262_p2;

assign zext_ln66_fu_218_p1 = select_ln63_2_fu_210_p3;

endmodule //CNN_CNN_Pipeline_VITIS_LOOP_63_7_VITIS_LOOP_64_828
