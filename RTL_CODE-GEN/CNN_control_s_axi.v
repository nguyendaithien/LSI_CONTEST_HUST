...
//        others - reserved
// 0x10 : Data signal of padding
//        bit 31~0 - padding[31:0] (Read/Write)
// 0x14 : reserved
// 0x18 : Data signal of width
//        bit 31~0 - width[31:0] (Read/Write)
// 0x1c : reserved
// 0x20 : Data signal of hight
//        bit 31~0 - hight[31:0] (Read/Write)
// 0x24 : reserved
...
localparam
    ...
    ADDR_IER            = 6'h08,
    ADDR_ISR            = 6'h0c,
    ADDR_PADDING_DATA_0 = 6'h10,
    ADDR_PADDING_CTRL   = 6'h14,
    ADDR_WIDTH_DATA_0   = 6'h18,
    ADDR_WIDTH_CTRL     = 6'h1c,
    ADDR_HIGHT_DATA_0   = 6'h20,
    ADDR_HIGHT_CTRL     = 6'h24,
    WRIDLE              = 2'd0,
    WRDATA              = 2'd1,
    WRRESP              = 2'd2,
    WRRESET             = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_HIGHT_DATA_0: begin
                    rdata <= int_hight[31:0];
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_HIGHT_DATA_0)
            int_hight[31:0] <= (WDATA[31:0] & wmask) | (int_hight[31:0] & ~wmask);
    end
end
